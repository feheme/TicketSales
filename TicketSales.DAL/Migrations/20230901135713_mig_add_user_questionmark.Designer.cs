...
namespace TicketSales.DAL.Migrations
{
    ...
    [Migration("20230901135713_mig_add_user_questionmark")]
    partial class mig_add_user_questionmark
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketSales.Model.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedDate = new DateTime(2023, 9, 1, 16, 57, 13, 596, DateTimeKind.Local).AddTicks(4943),
                            Email = "akb@mail.com",
                            FirstName = "Marty",
                            IsActive = true,
                            LastName = "McFly",
